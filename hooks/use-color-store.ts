...
const initialState: ColorState = {
  availableColors,
  defaultColor: availableColors[2].name,
  userColor: undefined,
}
...
//   defaultColor: string
//   userColor?: string 
//   setColor: (name: string, isUser?: boolean) => void
//   applyColors: (theme: ThemeMode) => void
// }
...
//       applyColors: (theme) => {
//         const { availableColors, userColor, defaultColor } = get()
        
//         const color =
//           availableColors.find((c) => c.name === userColor) ??
//           availableColors.find((c) => c.name === defaultColor)!
        
        
//         const vars =  theme === 'dark' ? color.dark : color.root
